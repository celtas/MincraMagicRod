...
Player player;
	...
	public void run() {
		if(player.getLocation().getBlockY()<170){
			...
			Version.playSound(player.getLocation(),Sound.ENTITY_ENDERMEN_TELEPORT, 0.5F, 1F);
			...
			Version.playSound(player.getLocation(),Sound.ENTITY_ENDERMEN_TELEPORT, 0.75F, 1F);
		}else{
