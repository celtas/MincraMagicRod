...
Plugin plugin;
	...
	public void run() {
		...
		wolf.setBreed(false);
		wolf2=(Wolf)player.getWorld().spawnEntity(player.getLocation(),EntityType.WOLF);
		...
		wolf3=(Wolf)player.getWorld().spawnEntity(player.getLocation(),EntityType.WOLF);
		...
		wolf4=(Wolf)player.getWorld().spawnEntity(player.getLocation(),EntityType.WOLF);
		...
		wolf5=(Wolf)player.getWorld().spawnEntity(player.getLocation(),EntityType.WOLF);
